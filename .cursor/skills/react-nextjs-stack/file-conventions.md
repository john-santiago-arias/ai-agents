...
Component declaration, component body order, import order, and the 300-line limit are universal rules — see `.cursor/rules/code-style.mdc` and `.cursor/rules/semantics-order.mdc`.
